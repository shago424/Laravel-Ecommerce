...
<!-- Content Wrapper. Contains page content -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Sub Catagory</li>
            </ol>
          </div> 
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <section class="col-md-6 offset-md-3">
           ...
           <div class="card">
              <div class="card-header" style="background-color: #086A87 ">
                <h5 style="color: white">Edit Sub Catagory
            ...
            <div class="card-body">
             ...
             <form method="POST" action="{{route('subcatagories.update-subcatagory',$editdata->id)}}" class="form-horizontal" id="myform">
          @csrf
          <div class="row">
 ...
 <div class="row">
          <div class="form-group col-sm-5">
              ...
              <div class="col-sm-7">
                  <input type="text" name="sub_catagory_name" class="form-control" value="{{$editdata->sub_catagory_name}}" id="sub_catagory_name" placeholder="Sub Catagory Name" data-validation="requierd">
          ...
          <div class="form-group">
              <div class="col-sm-12">
                  <button type="submit" class="btn btn-danger pull-right btn-block">Update Sub Catagory</button>
              </div>
          </div>
