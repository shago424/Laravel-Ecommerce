...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <section class="col-md-6 offset-md-3">
           ...
           <div class="card">
              <div class="card-header" style="background-color: #086A87 ">
                <h5 style="color: white">Add Slider
                  <a  href="{{route('sliders.view-slider')}}" class="btn btn-warning btn-sm float-right"><i class="fa fa-list"> Slider List</i></a>
                </h5>
              </div> 
            <div class="card-body">
                
             <form method="POST" action="{{route('sliders.store-slider')}}" class="form-horizontal"enctype="multipart/form-data" id="myform">
                                        @csrf
         ...
         <div class="row">
          ...
          <div class="col-md-8" >
     <input type="text" name="title" class="form-control" value="{{old('title')}}" id="title" placeholder="Slider Title" data-validation="requierd">
      @error('title')
      ...
      @enderror
         ...
         <div class="col-md-8" >
            <input type="text" name="sub_title" class="form-control" value="{{old('sub_title')}}" id="sub_title" placeholder="Slider Sub Title">
            @error('sub_title')
            <strong class="text-danger">{{$message}}</strong>
            @enderror
        </div>
    ...
    <div class="row">
         ...
         <div class="col-md-8" >
            <input type="text" name="url" class="form-control" value="{{old('url')}}" id="url" placeholder="URL">
            @error('url')
            <strong class="text-danger">{{$message}}</strong>
            @enderror
        </div>
      ...
      <div class="row">
         ...
         <div class="col-md-8" >
            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" name="start" class="form-control datetimepicker-input"placeholder="Start Date ( DD/MM/YYYY )" data-target="#reservationdate"/>
    ...
    <div class="row">
         ...
         <div class="col-md-8" >
           <div class="input-group date" id="reservationdate2" data-target-input="nearest">
                        <input type="text" name="end" class="form-control datetimepicker-input"placeholder=" End Date ( DD/MM/YYYY )" data-target="#reservationdate2"/>
