    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder"> 
          <!-- ============================================================= LOGO ============================================================= -->
          <div class="logo"> <a href="{{url('./')}}"> <img src="{{asset('assets/website/images/logo.png')}}" alt="logo"> </a> </div>
          <!-- /.logo --> 
          <!-- ============================================================= LOGO : END ============================================================= --> </div>
        <!-- /.logo-holder -->
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                ...
                <li class="active dropdown"> <a href="{{url('./')}}"data-hover="dropdown" class="dropdown-toggle">Home</a> </li>

                @foreach($catagories as $catagory)
                <li> <a href="{{url('/catagoryb/'. $catagory->catagory_slug)}}">{{$catagory->catagory_name}}</a>
