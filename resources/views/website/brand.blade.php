                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          ...
                          <div class="image"> <a href="{{url('/product/'.$product->product_slug)}}">
                            
                            <img  src="{{asset('upload/productimage/'.$product->image)}}" alt=""></a> 

                          </div>
                          <!-- /.image -->
                          <div style="width: 50px" class="tag new"><span>{{$product->color}}</span></div> 
                        </div>
                        <!-- /.product-image -->
                         @php($price = false)
